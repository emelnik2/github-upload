            ...
            <div class="tile is-parent is-vertical">
                <div class="tile is-child is-12">
                    ...
                    <div id="ejemplos-bolsas">
                        ...
                        $link = mysql_connect('borse.com.mx:3306', 'borse_oper', 'Y781rkB1n7RC');
                            if($link){
                                echo "Connected.";
                            }else{
                            ...
                            mysql_select_db('borse_imagenes', $link);

                            $query=" SELECT * from bolsas_para_boutiques ";
                        ...
                        <div class="media-box push">
                            <div class="media-box-image"  data-overlay-effect="push-up">
                                <div data-title="<?php echo htmlentities($row["data-title"]);?>" data-alt="<?php echo htmlentities($row["data-alt"]);?>" data-thumbnail="https://res.cloudinary.com/borsemx/image/upload/c_scale,h_256,w_256/v1530632672/bolsas-para-boutiques/<?php echo $row["image"];?>"></div>

                                <div class="thumbnail-overlay">
                                    <footer class="card-footer">
                                        <a class="card-footer-item button bttn-spaced bttn-fill bttn-sm bttn-primary bttn-no-outline forma_comercio" href="/contacto-es/forma-cotizacion-comercio-base.php">   
                                        <span class="fa fa-shopping-cart"></span>&nbsp; COTIZAR</a>
                                        <a href="#" class="card-footer-item mb-open-popup button bttn-fill bttn-sm bttn-primary bttn-no-outline" data-src="https://res.cloudinary.com/borsemx/image/upload/v1530632672/bolsas-para-boutiques/<?php echo $row["image"];?>">
