                ...
                <div class="tile is-child is-12">
                    ...
                    <div id="ejemplos-bolsas">
                        ...
                        $link = mysql_connect('borse.com.mx', 'borse_oper', 'Y781rkB1n7RC')
                            ...
                            $query=" SELECT * from bolsas_para_regalos ";
                        ...
                        <div class="media-box push">
                            <div class="media-box-image"  data-overlay-effect="push-up">
                                <div data-title="<?php echo htmlentities($row["data-title"]);?>" data-alt="<?php echo htmlentities($row["data-alt"]);?>" data-thumbnail="https://res.cloudinary.com/borsemx/image/upload/c_scale,h_256,w_256/v1530632672/bolsas-para-regalos/<?php echo $row["image"];?>"></div>
                                ...
                                <div class="thumbnail-overlay">
                                    <footer class="card-footer">
                                        ...
                                        <a href="#" class="card-footer-item mb-open-popup button bttn-fill bttn-sm bttn-primary bttn-no-outline" data-src="https://res.cloudinary.com/borsemx/image/upload/v1530632672/bolsas-para-regalos/<?php echo $row["image"];?>">
