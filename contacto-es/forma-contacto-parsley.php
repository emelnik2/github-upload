	...
	<form id="data_form" action="#" data-parsley-validate>	
		<div class="medium-12 columns" style="">
			<div class="medium-6 columns" style="background-color: white; padding-top: .5em; height: auto;">
				<div style="width: 15em; height: 7em;">
					<object data="/images-es/logos/logotipo-borse.svg" type="image/svg+xml" style="width: 100%;height: auto;"></object>					
				</div>
			</div>
		...
		<div class="medium-6 large-4 columns right">
			...
			<div class="medium-6 columns" style="margin-bottom:1em">
				<i style="background-image: url(/images-es/interface/ico-info.svg); width: 28px;height: 28px; float: left; display: block; top: -.3em; position: relative; margin-right: .5em;background-repeat: no-repeat;;margin-top:.3em"></i> <span style="font-size:1em;">SUS DATOS SON CONFIDENCIALES</span>
			</div>
			<div class="medium-6 columns" style="margin-bottom:1em">
				<i style="background-image: url(/images-es/interface/ico-lock.svg); width: 28px;height: 28px; float: left; display: block; top: -.3em; position: relative; margin-right: .5em;background-repeat: no-repeat;;margin-top:.3em"></i> <span style="font-size:1em"><a href="/aviso-de-privacidad" style="color:#404040;text-decoration: none;" target="_blank">NUESTRO AVISO DE PRIVACIDAD</a></span>
			</div>
			</div>					
		</div>
	</form>          
