...
ini_set("session.gc_maxlifetime", "18000");  session_start(); include ($_SERVER['DOCUMENT_ROOT']."/vk_includes/consulta_usuario_carrito.php");
...
?>
	...
	checkout: {
	type: "SendForm",
	url: "/vk_includes/bolsas-a-cotizar-enviar-v2.php",
	method: "POST" , 
	cartColumns: [
...
$('#data_form').on('submit', function (e) {
  ...
  $.ajax({
	type: 'post',
	url: '/vk_includes/consulta_usuario_carrito_v2.php',
	data: $('form').serialize(),
