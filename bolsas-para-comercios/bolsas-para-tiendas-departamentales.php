...
<?php include ($_SERVER['DOCUMENT_ROOT']."/dev/includes-es/canonical_sin_extension.php"); ?>
    ...
    include ($_SERVER['DOCUMENT_ROOT']."/dev/includes-es/head_comun.php");
            ...
            <div class="tile is-parent is-vertical">
                <div class="tile is-child is-12">
                    ...
                    <div id="ejemplos-bolsas">
                        ...
                        <!-- Conecto a la carpeta "bolsas-para-tiendas-departamentales" en cloudinary -->
                        <!-- Cambiar prefix a el nombre del folder en cloudinary del cual se quieren extraer las imágentes -->
                        <?php 

                        $api = new \Cloudinary\Api();
                        $result = $api->resources(array("type" => "upload", "prefix" => "bolsas-para-tiendas-departamentales/", "max_results" => 100, "context" => TRUE));
